...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="?i=profile">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="?i=employee">Employee Accounts</a>
                        <a class="collapse-item" href="?i=employee_files">Employee Files</a>
                        <a class="collapse-item" href="?i=applicant_files">Applicant Files</a>
                        <a class="collapse-item" href="?i=employee_history">Accounts History</a>
             ...
             <li class="nav-item">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <!-- <a class="collapse-item" href="?i=attendance">Monitor Attendance</a> -->
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseFour"
                    ...
                    <span>Recruit and Onboarding</span>
                </a>
                <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="?i=job_posting">Job Posting</a>
                        <a class="collapse-item" href="?i=job_applicants">Job Applicants</a>
                        <a class="collapse-item" href="?i=job_applicants_history">Job Applicant History</a>
                    </div>
                </div>
            </li>
