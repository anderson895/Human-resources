$('#addBtn').click(function() {
    var id = $(this).data('id');
    var FName = $('#employeeFName').val();
    var MName = $('#employeeMName').val();
    var LName = $('#employeeLName').val();
    ...
    var employeeDate_hired = $('#employeeDate_hired').val();
    var employeeDate_until = $('#employeeDate_until').val();
    ...
    {
        if (FName && LName && Email && Address && Birthday && Phone && Position && employeeRole) {
            ...
            formData.append("employeeDate_hired", employeeDate_hired);
            formData.append("employeeDate_until", employeeDate_until);
