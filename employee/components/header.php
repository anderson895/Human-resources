...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link " href="?p=attendance" >
                    <i class="fas fa-fw fa-calendar"></i>
                    <span>Attendance</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link " href="?p=attendance_history" >
                    <i class="fas fa-fw fa-calendar"></i>
                    <span>Attendance History</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link " href="?p=leave_request" >
                    <i class="fas fa-fw fa-file"></i>
                    <span>Filing Leave Request</span>
                </a>
            </li>

            <li class="nav-item">
                <a class="nav-link " href="?p=upload_documents" >
                    <i class="fas fa-fw fa-file"></i>
